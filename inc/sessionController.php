...
class MySessionHandler extends SessionHandler
{
    ...
    private $sessionPath = "/";
    private $sessionDomain = ".example.com"; // Wesite Domain
    ...
    {
        // Decrypt Session Data (doesn't working with PHP 7+)
    ...
    {
        // Encrypt Session Data (doesn't working with PHP 7+)
